      ...
      <div className="flex min-h-screen flex-col bg-slate-50">
              ...
              {submitted ? (
                <div className="py-8">
                  ...
                  <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500">
                    Su encuesta fue enviada correctamente. Su respuesta nos
                    ayudará a mejorar la atención.
                  </p>
                ...
                <>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Valoramos su tiempo. Por favor, califique su experiencia
                    hoy.
                  </p>
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-center gap-x-2 text-sm text-slate-500">
                    ...
                    <span>
                      {ticket.service_window?.name ??
                        "Ventanilla no asignada"}
                    </span>
                  </div>
                  ...
                  <form onSubmit={submit} className="mt-8 text-left">
                    ...
                    <p className="mt-4 text-center text-xs italic text-slate-400">
                      Su respuesta será procesada de forma anónima para fines
                      estadísticos.
                    </p>
                  </form>
                </>
        ...
        <footer className="border-t border-slate-200 bg-white">
          <div className="mx-auto flex min-h-14 w-full max-w-7xl flex-col items-center justify-between gap-2 px-5 py-4 text-xs text-slate-500 sm:flex-row sm:px-8">
            <span>
              © 2026 QueueCare AI — Universidad de Gestión Operativa
            </span>
